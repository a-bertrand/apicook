...
from apicook.cookie.models import Recipe, Article, ShopList, Ingredient
...
class TestListRecipe(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.ingredient_1 = mommy.make(Ingredient, quantity=1, measure_type=Ingredient.KG, article=cls.article, recipes=cls.recipe)
        cls.ingredient_2 = mommy.make(Ingredient, quantity=2, measure_type=Ingredient.KG, article=cls.article, recipes=cls.recipe)
        cls.ingredient_3 = mommy.make(Ingredient, quantity=2, measure_type=Ingredient.QUANTITY, article=cls.article, recipes=cls.recipe)
    ...
    def test_check_list(self):
        ...
        assert shop_list[0].measure_type == Ingredient.KG 
        assert shop_list[0].article.name == 'tomate'

        assert shop_list[1].total_quantity == 2
        assert shop_list[1].measure_type == Ingredient.QUANTITY
